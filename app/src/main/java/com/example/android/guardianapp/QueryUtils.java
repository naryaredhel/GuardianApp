...
import static com.example.android.guardianapp.MainActivity.LOG_TAG;
...
public final class QueryUtils {
    ...
    private static List<News> extractFeatureFromJson(String newsJSON) {
        ...
        try {
            ...
            // Extract the JSONArray associated with the key called "resulresponsets",
            ...
            for (int i = 0; i < newsArray.length(); i++) {
                ...
                if (tags.length() > 0) {
                    ...
                    author = author + tagsField.getString("webTitle");
                }
                // Create a new {@link News} object with the title, section, author, time,
                // and url from the JSON response.
                // Add the new {@link news} to the list of news.
                News news = new News(title, section, time, url, author);
    ...
    public static List<News> fetchNewsData(String requestUrl) {
        ...
        List<News> eNews = extractFeatureFromJson(jsonResponse);
